...
9. **THE FINAL REPORT IS CONCISE BY DESIGN.** Format governed entirely by `References_ReportFomatting.md`.
...
| `References_ReportFomatting.md` | Owns all final-output formatting for the user-facing report | Sub-agent | Step 4c |
...
For every candidate that survives both 4a and 4b, format per `References_ReportFomatting.md`.

---

## Final Output

There is only one output flow. Assemble it per `References_ReportFomatting.md`.
